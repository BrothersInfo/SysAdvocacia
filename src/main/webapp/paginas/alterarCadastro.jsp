...
<body>
	<div class="container">
			...
			<fieldset>
				...
				<div class="row" id="idContato">
					<div class="form-group col-md-2">
						<label for="nome">Código</label> <input
							class="form-control text-center" id="codigo"
							name="contato.codigo" value="${contato.codigo}"
							readonly="readonly" />
					</div>
				</div>
				...
				<div id="upload-button" class="col-md-2" style="float: right;">
					<img class="foto" height="128" data-src="default.jpg"
						...
						style="width: 140px; height: 140px;" src="${contato.foto}" />
				</div>

				<input class="file-upload" type="file"
					accept="image/png, image/jpg, image/jpeg, image/bmp"
					style="display: none;" /> <input id="photo" type="text"
					name="contato.foto" value="${contato.foto}" />
				...
				<div class="row">
					<div class="form-group col-md-12">
						<label for="lblEmail">Email</label> <input class="form-control"
							id="txtEmail" name="contato.email" value="${contato.email}"
		...
		<div class="modal fade" id="modalMAX" tabindex="-1" role="dialog"
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title text-center" id="myModalLabel"
							style="color: red;">FOTO MUITO GRANDE</h4>
					</div>
					<div class="modal-body text-center">Foto muito grande, a foto
						deve ser menor que 1MB</div>
