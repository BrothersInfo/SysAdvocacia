        ...
        <div class="container">
            <div class="row" id="login" style="height: 200; width: 300;">
                <div class="row">
                    <div class="input-group">
                        <span class="input-group-addon"><i
                                class="glyphicon glyphicon-user"></i></span> <input id="txtemail" name="txtemail"
                ...
                <div class="row">
                    <div class="input-group">
                        <span class="input-group-addon"><i
                                class="glyphicon glyphicon-lock"></i></span> <input id="txtsenha" name="txtsenha"
                ...
                <div id="closer" class="modal-dialog" role="document">
                    <div id="conteudo" class="modal-content">
                        ...
                        <div class="modal-body" style="height: 200px;">
                            ...
                            <div class="col-md-4">
                                Telefone:<input class="form-control"
                                                id="telefone" type="text"  />
                            </div>
                            <div class="col-md-8">
                                Endereço:<input id="endereco" class="form-control"
                                                type="text"  />
                            </div>
                            <div class="col-md-8">
                                Email:<input id="email" class="form-control"
                                             type="text"  />
                            </div>
                            <div class="col-md-4">
                                Senha:<input id="senha" class="form-control" 
                                             type="password" />
                            </div>
                        </div>
                        <div class="modal-footer">
                            <span id="divv" class="col-md-8 btn btn-default text-center" style="size: 14px; color: white; background-color: green; display: none;">USUÁRIO CADASTRADO CM SUCESSO!</span>
