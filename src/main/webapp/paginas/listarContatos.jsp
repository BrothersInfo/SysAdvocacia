                                                            ...
                                                            .ajax({
                                                                ...
                                                                success: function (
                                                                    ...
                                                                    for (var i = 0; i < response.listaContatos.length; i++) {
                                                                        linhas += "<tr>";
                                                                        linhas += "<td class='col-md-1'>" + response.listaContatos[i].codigo + "</td>";
                                                                        linhas += "<td class='col-md-4'>" + response.listaContatos[i].nome + "</td>";
                                                                        linhas += "<td class='col-md-2'>" + response.listaContatos[i].telefone + "</td>";
                                                                        linhas += "<td class='col-md-6'>" + response.listaContatos[i].email + "</td>";
