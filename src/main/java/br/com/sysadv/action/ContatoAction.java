...
public class ContatoAction extends ActionSupport {
    ...
    @Action(value = "salvarContato", results = {
    ...
    @Action(value = "novoContato", results = {
        @Result(name = "success", location = "/paginas/novoContato.jsp")})
    ...
    @Action(value = "listarContatos", results = {
        @Result(name = "success", location = "/paginas/listarContatos.jsp")})
    ...
    @Action(value = "listarContatosAJAX", results = {
    ...
    @Action(value = "excluirCliente", results = {
        @Result(name = "success", location = "/paginas/listarContatos.jsp")})
